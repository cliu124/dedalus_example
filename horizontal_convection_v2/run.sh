...
###ln -s /home/cliu124/dedalus_example/horizontal_convection_v2/X1_checkpoint_s1.h5 restart.h5
...
cp -r "$checkpoint_name" /mnt/d/Data/dedalus_example/horizontal_convection_v2
echo $today
echo "finished"
rm -rf restart.h5
...
%Update 2023/11/05 by Chang Liu, so it can solve generalized eigenvalue
%problem where some eigenvalues are Inf due to the singularity of the B
%matrices. 
Dseq(find(Dseq==Inf))=0;

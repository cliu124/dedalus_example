...
if flag.collision1!=0 and flag.collision2!=0:
    ...
    if flag.collision2<0:
        ...
        solver.state['T'].change_scales(1)
        ...
        solver.state['Tz'].change_scales(1)
        ...
        solver.state['w'].change_scales(1)
        ...
        solver.state['wz'].change_scales(1)
        ...
        solver.state['u'].change_scales(1)
        ...
        solver.state['p'].change_scales(1)
